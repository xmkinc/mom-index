...
# Platform-scoped keyword extensions.  Applied only when ``post.platform`` matches.
PLATFORM_KEYWORD_EXTENSIONS = {
    "xiaohongshu": {
        "newbie": {
            "身份自述": ["带娃", "家庭主妇", "上班族"],
            "知识求助": ["怎么办", "不会选股", "求带"],
            "决策依赖": ["现在入局还不晚", "入局", "还来得及吗"],
            "情绪恐慌": ["快跑", "逃命", "跑不跑", "回本", "被套了"],
            "过度乐观": ["满仓", "重仓", "三倍做多", "加杠杆"],
            "短期思维": ["今天买", "明天涨"],
        },
        "buy": [
            "现在入局还不晚", "入局", "还来得及吗", "满仓", "重仓",
            "三倍做多", "加杠杆", "抄底", "补仓摊平", "补仓",
            "还能买吗", "还能上车吗", "可以买吗", "能不能买", "要不要入",
            "想买", "想入", "心动",
            "后悔没买", "错过", "买少了", "早知道就买了", "再不买",
        ...
        "sell": [
            "快跑", "逃命", "跑不跑", "割肉", "止损", "清仓", "减仓",
            "出货", "卖了", "出了", "跑了", "走人", "不玩了", "离场", "下车", "赎回",
            "要不要割", "要不要走", "该不该卖", "还能留吗", "要不要清",
            "想卖", "想走", "想割", "想跑",
            "抄底失败", "回本", "被套了", "亏了", "亏麻了", "亏惨了", "深套",
            "套牢", "后悔买了",
            "跌麻了", "跌惨了", "血亏", "亏死", "跌死", "跌崩",
        ],
    }
